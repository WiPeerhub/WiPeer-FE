...
물리적인 공간에서 "같은 장소에 있다"는 것은 보통 같은 건물, 같은 층, 혹은 같은 실내 공간 등을 의미합니다. 하지만 온라인 환경에서 사람들이 “같은 공간에 있다”는 것을 어떻게 정의할 수 있을까요?
...
### 1.2 사용자 입장부터 채팅방 공유까지

## WebRTC를 활용한 Latency 최적화

## 채팅방 검색시 초성 검색 및 오타 허용

### 한글 유니코드 조합 규칙을 활용한 초성 검색
