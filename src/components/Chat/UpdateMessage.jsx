export default function UpdateMessage({ newMessage, updateMessage, handleUpdateMessage, setIsEditing }) {
  return (
    <div className="mt-1 flex flex-col gap-1">
      <div className="border-t border-gray-200 bg-yellow-100 p-3">
